...
public class UsersImpl implements IUsers {
   ...
   @Override
    ...
    @Override
    public Optional<Users> findUsersByUEmailAndUPassword(String email, String password) {
        return Optional.ofNullable(usersRepository.findUsersByUEmailAndUPassword(email, password));
    }

    @Override
    public Optional<Users> findUsersByULogin(String login) {
        return Optional.ofNullable(usersRepository.findUsersByULogin(login));
    }

    @Override
    public Optional<Users> findUsersByEmail(String email) {
        return Optional.ofNullable(usersRepository.findUsersByUEmail(email));
    }

    @Override
    public Optional<Users> findUsersByUStatus(String status) {
        return Optional.ofNullable(usersRepository.findUsersByUStatus(status));
    }
}